...
public class ListTester {
	...
	private void runTests() {
		...
		testEmptyList(A_iterRemoveAfterPrevA_emptyList, "A_iterRemoveAfterPrevA_emptyList");
		...
		testTwoElementList(A_iteratorAddB_BA, "A_iteratorAddB_BA", LIST_BA, STRING_AB);
		
		//1-element to changed 1-element via set()
		testSingleElementList(A_set_B, "A_set_B", LIST_B, STRING_B); 
		testSingleElementList(A_iterSetB_B, "A_iterSetB_B", LIST_B, STRING_B);
		...
		testSingleElementList(AB_iterRemoveAfterPrevB_A, "AB_iterRemoveAfterPrevB_A", LIST_A, STRING_A);
		...
		testTwoElementList(ABC_iterRemoveAfterNext_AC, "ABC_iterRemoveAfterNext_AC", LIST_AC, STRING_AC);
	 ...
	 * @return [A,B,C] after addToFrontC
	 */
	...
	/** Scenario: [A,B,C] -> removeC -> [A,B] 
	 * @return [A,B] after removeC
	 */
	...
	/** Scenario: [A,B] -> set0C -> [C,B] 
	 * @return [C,B] after set0C
	 */
	...
	/** Scenario: [A,B] -> set1C -> [A,C] 
	 * @return [A,C] after set1C
	 */
	 ...
	 */
	private IndexedUnsortedList<Integer> ABC_iterRemoveAfterNext_AC() {
		IndexedUnsortedList<Integer> list = AB_addAfterCB_ABC(); 
		Iterator<Integer> it = list.iterator();
		it.next();
		it.next();
	...
	private Scenario<Integer> ABC_iterRemoveAfterNext_AC = () -> ABC_iterRemoveAfterNext_AC();
	
	/** Scenario: [A,B,C] -> remove0 -> [B,C] 
	 * @return [B,C] after remove0
	 */
	...
	/** Scenario: [A,B,C] -> remove1 -> [A,C] 
	 * @return [A,C] after remove1
	 */
	...
	/** Scenario: [A,B,C] -> remove2 -> [A,B] 
	 * @return [A,B] after remove2
	 */
...
71) [A] -> iterator set(B) after next() returns A -> [B] --
	...
	/** Scenario: [A] -> iterRemoveAfterPrevA -> [] 
	 * @return [] after iterRemoveAfterPrevA
	 */
	...
	/** Scenario: [A,B] -> iterRemoveAfterPrevB -> [A] 
	 * @return [A] after iterRemoveAfterPrevB
	 */
	...
	/** Scenario: [A] -> iteratorAddB -> [B,A] 
	 * @return [B,A] after iteratorAddB
	 */
	private IndexedUnsortedList<Integer> A_iteratorAddB_BA() {
		IndexedUnsortedList<Integer> list = emptyList_addToFrontA_A(); 
	...
	private Scenario<Integer> A_iteratorAddB_BA = () -> A_iteratorAddB_BA();

	/** Scenario: [A] -> iteratorSetB returns A -> [B] 
	 * @return [B] after iteratorSetB
	 */
	private IndexedUnsortedList<Integer> A_iterSetB_B() {
		IndexedUnsortedList<Integer> list = emptyList_addToFrontA_A(); 
		ListIterator<Integer> lit = list.listIterator();
		lit.next();
		lit.set(ELEMENT_B);
	...
	private Scenario<Integer> A_iterSetB_B = () -> A_iterSetB_B();
	...
	private void testTwoElementList(Scenario<Integer> scenario, String scenarioName, Integer[] contents, String contentsString) {
		...
		try {
			...
			printTest(scenarioName + "_testRemoveIndexX", testRemoveIndex(scenario.build(), 2, ELEMENT_X, Result.IndexOutOfBounds));
			// Iterator 
			printTest(scenarioName + "_testIter", testIter(scenario.build(), Result.NoException));
			printTest(scenarioName + "_testIterHasNext", testIterHasNext(scenario.build().iterator(), Result.True));
			printTest(scenarioName + "_testIterNext", testIterNext(scenario.build().iterator(), contents[0], Result.MatchingValue));
			...
			if (SUPPORTS_LIST_ITERATOR) {
				...
				printTest(scenarioName + "_testListIterRemove", testIterRemove(scenario.build().listIterator(), Result.IllegalState));
				printTest(scenarioName + "_testListIterAdd", testListIterAdd(scenario.build().listIterator(), ELEMENT_X, Result.NoException));			
				printTest(scenarioName + "_testListIterSet", testListIterSet(scenario.build().listIterator(), ELEMENT_X, Result.IllegalState)); //---- make test for each place at iterator
				printTest(scenarioName + "_testListIterNextRemove", testIterRemove(listIterAfterNext(scenario.build().listIterator(), 1), Result.NoException));
				printTest(scenarioName + "_testListIterNextAdd", testListIterAdd(listIterAfterNext(scenario.build().listIterator(), 1), ELEMENT_X, Result.NoException));			
				printTest(scenarioName + "_testListIterNextSet", testListIterSet(listIterAfterNext(scenario.build().listIterator(), 1), ELEMENT_X, Result.NoException)); //---
				printTest(scenarioName + "_testListIterNextRemoveRemove", testIterRemove(listIterAfterRemove(listIterAfterNext(scenario.build().listIterator(), 1)), Result.IllegalState));
				...
				//TODO: potentially add tests for nextnext/previousprevious
				...
				//maybe add some for next calls (remove, add, set, etc.)
				printTest(scenarioName + "_testListIter1NextIndex", testListIterNextIndex(scenario.build().listIterator(1), 1, Result.MatchingValue));
				printTest(scenarioName + "_testListIter1HasPrevious", testListIterHasPrevious(scenario.build().listIterator(1), Result.True));
				printTest(scenarioName + "_testListIter1Previous", testListIterPrevious(scenario.build().listIterator(1), contents[0], Result.MatchingValue));
				printTest(scenarioName + "_testListIter1PreviousIndex", testListIterPreviousIndex(scenario.build().listIterator(1), 0, Result.MatchingValue));
	...
	private void testThreeElementList(Scenario<Integer> scenario, String scenarioName, Integer[] contents, String contentsString) {
		...
		try {
			...
			printTest(scenarioName + "_testRemoveIndexX", testRemoveIndex(scenario.build(), 3, ELEMENT_X, Result.IndexOutOfBounds));
			// Iterator
			printTest(scenarioName + "_testIter", testIter(scenario.build(), Result.NoException));
			printTest(scenarioName + "_testIterHasNext", testIterHasNext(scenario.build().iterator(), Result.True));
			printTest(scenarioName + "_testIterNext", testIterNext(scenario.build().iterator(), contents[0], Result.MatchingValue));
			...
			printTest(scenarioName + "_iterNextNextRemove_testIterRemove", testIterRemove(iterAfterRemove(iterAfterNext(scenario.build(), 2)), Result.IllegalState));
			printTest(scenarioName + "_iterNextRemoveNext_testIterHasNext", testIterHasNext(iterAfterNextRemove(iterAfterRemove(iterAfterNext(scenario.build(), 1))), Result.True));
			printTest(scenarioName + "_iterNextRemoveNext_testIterNext", testIterNext(iterAfterNextRemove(iterAfterRemove(iterAfterNext(scenario.build(), 1))), contents[2], Result.MatchingValue));
			printTest(scenarioName + "_iterNextRemoveNext_testIterRemove", testIterRemove(iterAfterNextRemove(iterAfterRemove(iterAfterNext(scenario.build(), 1))), Result.NoException));
			printTest(scenarioName + "_iterNextNextRemoveNext_testIterHasNext", testIterHasNext(iterAfterNextRemove(iterAfterRemove(iterAfterNext(scenario.build(), 2))), Result.False));
			printTest(scenarioName + "_iterNextNextRemoveNext_testIterNext", testIterNext(iterAfterNextRemove(iterAfterRemove(iterAfterNext(scenario.build(), 2))), null, Result.NoSuchElement));
			printTest(scenarioName + "_iterNextNextRemoveNext_testIterRemove", testIterRemove(iterAfterNextRemove(iterAfterRemove(iterAfterNext(scenario.build(), 2))), Result.NoException));
	...
	// 	System.out.println("\nListIterator Concurrency Tests\n");
	// 	try {
	// 		// will add for double-linked list
	// 	} catch (Exception e) {
	// 		System.out.printf("***UNABLE TO RUN/COMPLETE %s***\n", "test_ListIterConcurrency");
	// 		e.printStackTrace();
	// 	} finally {
